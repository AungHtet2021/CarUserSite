        ...
        <div class="col-lg-6">
          <div class="row justify-content-start">
           ...
           <!-- <DefaultInfoCard           
            ...
            <div class="col-12" style="background-color: #794e41; border-radius: 8px;">
            <h4 class="text-white mt-1 px-3 ">User Name</h4>
            <!-- <h5 class="text-white mt-4 px-3 ">{{ newUser.name }}</h5> -->
            <input type="text" class=" px-3 mb-4" style="border-radius:8px; border-color:none" v-model="newUser.name">
        
            <h4 class="text-white mt-1 px-3 ">Gmail</h4>
            <input type="text" class=" px-3 mb-4" style="border-radius:8px; border-color:none" v-model="newUser.gmail">
            <!-- <h5 class="text-white mt-4 px-3 ">{{ newUser.gmail }}</h5> -->
            <h4 class="text-white mt-1 px-3 ">Phone Number</h4>
            <input type="text" class=" px-3 mb-4" style="border-radius:8px; border-color:none" v-model="newUser.phone">
          </div>
