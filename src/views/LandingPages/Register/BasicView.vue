    ...
    async register() {
      ...
      if (respPosterData) {
        ...
        if (resp.status == 200) {
          ...
          alertify.error("Gmail Already Exit")
        }
      }
    },
  },
        ...
        <div class="welcome containerRegister">
          <v-form ref="categoryForm " v-model="categoryForm">
            ...
            <input
              ...
              @change="onFilePicked"
            />
            <span id="blankImage" style="color: red; visibility: hidden"
              >Pls Fill the User Profile!</span
            >
